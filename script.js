...
async function loadHome() {
  ...
  try {
    ...
    + `<a class="subject-card" href="https://vidyaverse-pw.ai.studio/#/" target="_blank" rel="noopener noreferrer"><div class="sc-top" style="background:linear-gradient(135deg,#6366f1,#4f46e5)"><span class="sc-icon">🎥</span></div><div class="sc-body"><h3>PW Free Lecture</h3><div class="sc-arrow"><span>Open Lectures</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" x2="21" y1="14" y2="3"/></svg></div></div></a>`
